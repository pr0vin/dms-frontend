  ...
  return (
    <>
      <div
        ...
        className={`md:hidden fixed inset-0 max-h-screen z-[90] bg-black/50 ${
      ...
      <motion.div
        ...
        className="bg-gray-800 text-white flex-none shadow-xl z-[99] w-[16rem] max-w-[16rem] h-screen overflow-hidden md:relative fixed"
      >
        {/* menus */}
